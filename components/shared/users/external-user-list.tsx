...
interface ExternalUserListProps {
  searchQuery: string;
  onUserAction?: (action: string, user: ExternalUser) => void;
}
...
export function ExternalUserList({ searchQuery, onUserAction }: ExternalUserListProps) {
                ...
                <TableCell className="text-right">
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                      ...
                      <DropdownMenuItem onClick={() => onUserAction?.('transfer_org', user)}>
